UPDATEusers SET email='_ADMIN_EMAIL_', passwordReset=true, passwordResetToken=md5(random()::text) WHERE id=1;
...
INSERT INTO applications (id, pkg, name, showicon, customerid, system, latestversion, runafterinstall) VALUES 
   ...
   (22, 'com.huawei.camera', 'Камера (Huawei)', true, 1, true, 10021, false),
    ...
    (27, 'com.google.android.apps.maps', 'КартыGoogle', true, 1, true, 10026, false),
...
(41, 'com.sec.phone', 'Телефон (Samsung)', true, 1, true, 10040, false),
   ...
   (53, 'com.miui.notes', 'MIUI Заметки', true, 1, true, 10052, false),
	...
	(76, 'com.google.android.gms.setup', 'Настройка GoogleServices', false, 1, true, 10075, false),
...
(1, 'Управляемый Лаунчер', 'Лаунчер Headwind MDM отображает иконки только разрешенных администратором приложений. Для управления разрешенными приложениями используйте вкладкуПриложения.', 0, '12345678', '', '', NULL, 'SMALL', 'NO_HEADER', true, 1, NULL, NULL, NULL, NULL, 10045, 'com.hmdm.launcher.AdminReceiver', false, '6fb9c8dc81483173a0c0e9f8b2e46be1', NULL, false, false, 0, NULL, NULL, 'mqttAlarm', 300, NULL, NULL, true),
...
(3, 'Фоновый режим', 'HeadwindMDM работает в фоне, не ограничивая возможности пользователя.', 0, '12345678', '', '', NULL, 'SMALL', 'NO_HEADER', true, 1, NULL, NULL, NULL, NULL, 10045, 'com.hmdm.launcher.AdminReceiver', false, '350e0fb7fc3f4b7fe61cac75fd43818f', NULL, false, false, 0, NULL, NULL, 'mqttAlarm', 300, true, true, true);
...
VALUES (2, 'devicetracker', 'Трекер устройств', 'Отслеживание местоположения устройств на карте', false, 'plugin.devicetracker.name', 'devicetracker.settings', 'devicetracker.functions', 'devicetracker.devicefunctions', true);

-- Register Settings plugin
INSERT INTO plugins (id, identifier, name, description, disabled, nameLocalizationKey, settingsPermission, functionsPermission, deviceFunctionsPermission, enabledForDevice) 
VALUES (3, 'settings', 'Управление настройками', 'Управление настройками устройств', false, 'plugin.settings.name', 'settings.settings', 'settings.functions', 'settings.devicefunctions', true);

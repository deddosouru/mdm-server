UPDATEuserroles SET name='Super-Admin', description='Can sign in as any user. In shared mode, manages corporate accounts' WHERE id=1;
UPDATE userroles SET name='Admin', description='Full access to the control panel' WHERE id=2;
UPDATE userroles SET name='User', description='Limited accessto the control panel' WHERE id=3;
...
UPDATE groupsSET name='General' WHERE id=1;
...
UPDATE permissions SETdescription='Access to devices' WHERE id=4;
...
INSERT INTOconfigurations (id, name, description, type, password, backgroundcolor, textcolor, backgroundimageurl, iconsize, desktopheader, usedefaultdesignsettings, customerid, gps, bluetooth, wifi, mobiledata, mainappid, eventreceivingcomponent, kioskmode, qrcodekey, contentappid,autoupdate, blockstatusbar, systemupdatetype, systemupdatefrom, systemupdateto, pushoptions, keepalivetime, rundefaultlauncher, permissive, kioskexit) VALUES 
(1, 'Managed Launcher', 'Displays a set of application icons predefined by the administrator. To show or hideapplications, use the Applications tab.', 0, '12345678', '', '', NULL, 'SMALL', 'NO_HEADER', true, 1, NULL, NULL, NULL, NULL, 10045, 'com.hmdm.launcher.AdminReceiver', false, '6fb9c8dc81483173a0c0e9f8b2e46be1', NULL, false, false, 0, NULL, NULL, 'mqttAlarm', 300, NULL, NULL, true),
...
INSERT INTO configurationapplications (id, configurationid, applicationid, remove, showicon, applicationversionid) VALUES 
	...
	(47, 1, 58, false, false, 10057),
	(48, 1, 59, false, false, 10058),
    (49, 1, 60, false, false, 10059),
    (50, 1, 61, false, false, 10060),
    (51, 1, 62, false, false, 10061),
    (52, 1, 63, false, true, 10062),
    (53, 1, 64, false, true, 10063),
    (54, 1, 66, false, true, 10065),
    (55, 1, 67, false, true, 10066),
    (56, 1, 68, false, true, 10067),
    (57, 1, 69, false, true, 10068),
    (58, 1, 71, false, false, 10070),
    (59, 1, 74, false, false, 10073),
    (60, 1, 75, false, false, 10074),
    (61, 1, 76, false, false, 10075),
    (62, 1, 77, false, false, 10076),
    (63, 1, 78, false, false, 10078),
    (64, 1, 79, false, false, 10079),
    (65, 1, 80, false, false, 10080),
    (66, 1, 81, false, false, 10081),
    (67, 1, 83, false, false, 10083),
    (68, 1, 84, false, false, 10084),
    (69,1, 85, false, true, 10085),
    (70, 1, 86, false, false, 10086),
    (71, 1, 88, false, false, 10088),
   (72, 1, 94, false, false, 10094),
    (73, 1, 95, false, false, 10095),
    (74, 1, 99, false, false, 10099),
	
	(100, 2, 8, false, true, 10007),
    (101, 2, 37, false, false, 10036),
    (102, 2, 2, false,false, 10001),
    (103, 2, 21, false, true, 10020),
    (104, 2, 9, false, true, 10008),
    (105, 2,29, false, true, 10028),
    (106, 2, 34, false, true, 10033),
    (107, 2, 35, false, false, 10034),
    (108, 2, 13, false, false, 10012),
    (109, 2, 6, false, false, 10005),
    (110, 2, 4, false, false, 10003),
    (111, 2, 27, false, false, 10026),
    (112, 2, 15, false, false, 10014),
    (113, 2, 3, false, false, 10002),
    (114, 2, 12, false, false, 10011),
    (115, 2, 38, false, true, 10037),
    (116, 2,39, false, true, 10038),
    (117, 2, 5, false, false, 10004),
    (118, 2, 17, false, false, 10016),
    (119, 2, 42, false, true, 10041),
    (120, 2, 40, false, true, 10039),
    (121, 2, 28, false, false, 10027),
    (122, 2, 1, false, false, 10000),
    (123, 2, 46, false, false, 10045),
    (124, 2, 48, false, true, 10047),
    (125, 2, 49, false, true, 10048),
    (126, 2, 50, false, false, 10049),
    (127, 2, 51, false, false, 10050),
    (128, 2, 52, false, false, 10051),
    (129, 2, 53, false, false, 10052),
(130, 2, 54, false, false, 10053),
    (131, 2, 55, false, false, 10054),
    (132, 2, 56, false, false,10055),
    (133, 2, 57, false, false, 10056),
...
-- Register Device Tracker plugin
INSERT INTO plugins (id, identifier, name, description, disabled, nameLocalizationKey, settingsPermission, functionsPermission, deviceFunctionsPermission, enabledForDevice) 
VALUES (2, 'devicetracker', 'Device Tracker', 'Track device locations on the map', false, 'plugin.devicetracker.name', 'devicetracker.settings', 'devicetracker.functions', 'devicetracker.devicefunctions', true);

-- Register Settings plugin
INSERT INTO plugins (id, identifier, name, description, disabled, nameLocalizationKey, settingsPermission, functionsPermission, deviceFunctionsPermission, enabledForDevice) 
VALUES (3, 'settings', 'Settings Management', 'Manage device settings', false, 'plugin.settings.name', 'settings.settings', 'settings.functions', 'settings.devicefunctions', true);

SELECT pg_catalog.setval('public.plugins_id_seq', 3, true);

...
/**
 * <p>A plugin configuration implementation for Device Tracker plugin.</p>
 *
 * @author isv
 */
public class DeviceTrackerPluginConfigurationImpl implements PluginConfiguration {

    /**
     * <p>Constructs new <code>DeviceTrackerPluginConfigurationImpl</code> instance. This implementation does nothing.</p>
     */
    public DeviceTrackerPluginConfigurationImpl() {
    }
    ...
    public List<Module> getPluginModules(ServletContext context) {
        ...
        modules.add(new DeviceTrackerPluginModule());
        return modules;
    }
